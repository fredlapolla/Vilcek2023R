---
title: "Intro to R for Data Analysis: Intro to the R Environment"
author: "Fred LaPolla"
...
R is case sensitive and does not guess alternate spellings.


Look for **typos!**

This can mean extra commas, periods, and parentheses that don't close. Sometimes the error message will clue you in, other times not. 
...
If the console presents a plus sign with a blinking cursor, it means something did not close to execute. The easiest solution is to hit **ESC.**
...
For demo purposes: https://github.com/fredlapolla/Vilcek2023R/tree/main
